...
THREEx.Planets.createSun	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 64, 64)
	var texture	= THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/sunmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05*((diameter/100)+1),
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
}

THREEx.Planets.createMercury	= function(diameter){
...
THREEx.Planets.createVenus	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createEarth	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createMoon	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createMars	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createJupiter	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
...
THREEx.Planets.createSaturn	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
...
THREEx.Planets.createUranus	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
...
THREEx.Planets.createNeptune	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
...
THREEx.Planets.createPluto	= function(diameter){
	var geometry	= new THREE.SphereGeometry(diameter, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
